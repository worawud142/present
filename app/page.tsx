...
const values = [
  ...
  ['จรรยาบรรณวิชาชีพ', 'วางตนเหมาะสม และปฏิบัติต่อผู้เรียนอย่างเป็นธรรม', 20],
  ...
  ['จิตสำนึกความรับผิดชอบในวิชาชีพ', 'พัฒนางานและร่วมมือกับเพื่อนครู', 21],
] as const;
const practice = [
...
const projects = [
  ...
  },
  {
    ...
    photos: [41, 35, 104],
    captions: ['การฝึกปฏิบัติด้านหุ่นยนต์', 'การเตรียมตัวและพัฒนาทักษะ', 'การอบรมหุ่นยนต์ร่วมกับเครือข่าย'],
    detail: 11,
...
const galleryLabels: Record<number, string> = {
  ...
  101: 'รับการนิเทศเปิดภาคเรียน',
  102: 'ประชุมและแลกเปลี่ยนการทำงาน',
  105: 'เยี่ยมบ้านและดูแลช่วยเหลือผู้เรียน',
  106: 'ทำงานร่วมกับผู้ปกครอง',
  107: 'เข้าถึงผู้เรียนและครอบครัว',
  109: 'สร้างความร่วมมือกับชุมชน',
    ...
    <main ref={root}>
      ...
      <section id="about" className="scene about-section">
        ...
        <img
          ...
          src="/photos/image103.webp"
          alt="การรับการนิเทศและข้อเสนอแนะ"
          loading="lazy"
        />
        <img
